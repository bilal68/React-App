import { Button, Form, Input, Space, Card, Row, Typography, Col } from "antd";
...
const CreateGistForm = () => {
  ...
  const onFinish = async (values: any) => {
    try {
      ...
      // Transform files array into the required format
      const formattedFiles = files.reduce((acc: any, file: any) => {
      ...
      form.resetFields(); // Reset the form after successful creation
    } catch (error) {
        ...
        >
          ...
          >
            <Form.Item name="description">
              <Input placeholder="This is a Gist Description" />
            </Form.Item>
